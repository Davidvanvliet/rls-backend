...
public class URL implements Iterable<URL.Parameter> {
     ...
     * provided.
     *
     * @param url The external form of the URL. Ex: http://www.google.com If this
     *            parameter is empty or invalid an IllegalArgumentException is
     *            thrown. If this parameter is null a NullPointerException.
     * @throws IllegalArgumentException Thrown if url is not valid.
     ...
     * invalid.
     *
     * @param url The external form of a URL.
     ...
     *
     * @param url    The external form of a URL.
     * @param defaul The URL that should be returned in cases where the primary url is
     *               invalid.
     * @return A URL object for the provided String, or null if the URL provided
     * is invalid.
     */
     ...
     *
     * @param name  The name of the parameter. It is automatically encoded if
     *              necessary. If null or empty is passed silently no parameter is
     *              added.
     * @param value The value of the parameter. It is automatically encoded if
     ...
     *
     * @param name The name of the parameter to decrement. Null and or an empty
     ...
     *
     * @param name   The name of the parameter to return. The name is automatically
     *               encoded if necessary.
     * @param defaul If the is no parameter to return, this value is returned instead.
     ...
     *
     * @param name The name of the parameter(s) to return. The name is automatically
     *             encoded if necessary.
    ...
    /**
     * @param protocol The protocol name, in any case, without :// Examples: http, HTTPS,
     *                 ftp
     * @return This object for chaining.
     * @throws IllegalArgumentException If not such protocol is supported, IllegalArgumentException is
     *                                  thrown.
     */
     ...
     *
     * @param The name of the parameter(s) to remove. Null or empty string will
     ...
     *
     * @param queryString Either a whole URL ("http://www.shopobot.com/?query=test") or just
     ...
     *
     * @param string A string reresenting the authority to check against this url.
    ...
    public class Parameter {
         ...
         *
         * @param name The name of the parameter. Silently accepts null and empty
         ...
         *              strings, however a blank parameter will be returned when
         *              toString() is called.
         * @param value The value of the parameter. Accepts null and empty strings.
         */
