...
public class TrainController {
    ...
    public Response<TrainDto> create(@RequestBody TrainPostDto dto) {
        int ownerId = securityContext.getOwnerId();
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public Response<TrainDto> update(@PathVariable int trainId, @RequestBody TrainPostDto trainCreateDto) {
        int ownerId = securityContext.getOwnerId();
