...
// */
//public class RepresentationModel implements Identifiable<Link> {
//
...
//        return getLink(String.valueOf(IanaLinkRelations.SELF));
//    }
//
//    /**
...
//        Link newLink = new Link(link.getTemplate(), link.getRel());
